...
chrome.storage.sync.get({ selected: 'images/labubu-01.jpg' }).then(result => {
...
function select(path, card) {
    chrome.runtime.sendMessage({ type: 'APPLY_THEME', path });
    chrome.storage.sync.set({ selected: path });
